...
},{"./boot.js":"node_modules/@polymer/polymer/lib/utils/boot.js","./wrap.js":"node_modules/@polymer/polymer/lib/utils/wrap.js"}],"node_modules/@polymer/polymer/lib/mixins/disable-upgrade-mixin.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.DisableUpgradeMixin = exports.findObservedAttributesGetter = void 0;
...
exports.findObservedAttributesGetter = findObservedAttributesGetter;
...
},{"./element-mixin.js":"node_modules/@polymer/polymer/lib/mixins/element-mixin.js","../utils/mixin.js":"node_modules/@polymer/polymer/lib/utils/mixin.js","../utils/wrap.js":"node_modules/@polymer/polymer/lib/utils/wrap.js"}],"node_modules/@polymer/polymer/lib/legacy/legacy-element-mixin.js":[function(require,module,exports) {
"use strict";
...
var _disableUpgradeMixin = require("../mixins/disable-upgrade-mixin.js");
...
const LegacyElementMixin = (0, _mixin.dedupingMixin)(base => {
   ...
   * @private
   */
  const GesturesElement = (0, _gestureEventListeners.GestureEventListeners)((0, _elementMixin.ElementMixin)(base)); // Note, the DirMixin does nothing if css is built so avoid including it
  // in that case.
  ...
  const legacyElementBase = _elementMixin.builtCSS ? GesturesElement : (0, _dirMixin.DirMixin)(GesturesElement);
  const observedAttributesGetter = (0, _disableUpgradeMixin.findObservedAttributesGetter)(legacyElementBase);
  /**
...
const LegacyElement = (0, _legacyElementMixin.LegacyElementMixin)(HTMLElement);
...
exports.showHideChildren = showHideChildren;
...
class DomRepeat extends domRepeatBase {
  ...
  static get properties() {
    ...
    return {
      ...
      renderedItemCount: {
        type: Number,
        notify: !_settings.suppressTemplateNotifications,
        readOnly: true
      },
  ...
  __render() {
    ...
    if (!_settings.suppressTemplateNotifications || this.notifyDomChange) {
      this.dispatchEvent(new CustomEvent('dom-change', {
        bubbles: true,
        composed: true
      }));
 ...
 *   implementation.
 */
class DomIfBase extends _polymerElement.PolymerElement {
  // Not needed to find template; can be removed once the analyzer
  // can find the tag name from customElements.define call
  static get is() {
    return 'dom-if';
  ...
  __ensureInstance() {
    let parentNode = (0, _wrap.wrap)(this).parentNode;
...
const DomIf = _settings.fastDomIf ? DomIfFast : DomIfLegacy;
exports.DomIf = DomIf;
customElements.define(DomIf.is, DomIf);
},{"../../polymer-element.js":"node_modules/@polymer/polymer/polymer-element.js","../utils/debounce.js":"node_modules/@polymer/polymer/lib/utils/debounce.js","../utils/flush.js":"node_modules/@polymer/polymer/lib/utils/flush.js","../utils/async.js":"node_modules/@polymer/polymer/lib/utils/async.js","../utils/path.js":"node_modules/@polymer/polymer/lib/utils/path.js","../utils/wrap.js":"node_modules/@polymer/polymer/lib/utils/wrap.js","../utils/hide-template-controls.js":"node_modules/@polymer/polymer/lib/utils/hide-template-controls.js","../utils/settings.js":"node_modules/@polymer/polymer/lib/utils/settings.js","../utils/templatize.js":"node_modules/@polymer/polymer/lib/utils/templatize.js"}],"node_modules/@polymer/polymer/lib/elements/array-selector.js":[function(require,module,exports) {
"use strict";
...
document.head.appendChild(style);
},{"@polymer/polymer/polymer-legacy.js":"node_modules/@polymer/polymer/polymer-legacy.js","@polymer/polymer/lib/utils/html-tag.js":"node_modules/@polymer/polymer/lib/utils/html-tag.js"}],"node_modules/@polymer/iron-meta/iron-meta.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.IronMeta = void 0;
...
},{"@polymer/polymer/polymer-legacy.js":"node_modules/@polymer/polymer/polymer-legacy.js","@polymer/polymer/lib/legacy/polymer-fn.js":"node_modules/@polymer/polymer/lib/legacy/polymer-fn.js"}],"node_modules/@polymer/iron-icon/iron-icon.js":[function(require,module,exports) {
"use strict";

require("@polymer/iron-flex-layout/iron-flex-layout.js");

var _ironMeta = require("@polymer/iron-meta/iron-meta.js");
...
template.setAttribute('style', 'display: none;');
document.head.appendChild(template.content);
},{"@polymer/polymer/polymer-legacy.js":"node_modules/@polymer/polymer/polymer-legacy.js","@polymer/polymer/lib/utils/html-tag.js":"node_modules/@polymer/polymer/lib/utils/html-tag.js"}],"node_modules/@polymer/paper-styles/default-theme.js":[function(require,module,exports) {
"use strict";
...
template.setAttribute('style', 'display: none;');
document.head.appendChild(template.content);
},{"@polymer/polymer/polymer-legacy.js":"node_modules/@polymer/polymer/polymer-legacy.js","./color.js":"node_modules/@polymer/paper-styles/color.js","@polymer/polymer/lib/utils/html-tag.js":"node_modules/@polymer/polymer/lib/utils/html-tag.js"}],"node_modules/@polymer/iron-behaviors/iron-control-state.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.IronControlState = void 0;
...
},{"@polymer/polymer/polymer-legacy.js":"node_modules/@polymer/polymer/polymer-legacy.js","@polymer/polymer/lib/legacy/polymer.dom.js":"node_modules/@polymer/polymer/lib/legacy/polymer.dom.js"}],"node_modules/@polymer/iron-a11y-keys-behavior/iron-a11y-keys-behavior.js":[function(require,module,exports) {
"use strict";
...
},{"@polymer/polymer/polymer-legacy.js":"node_modules/@polymer/polymer/polymer-legacy.js"}],"node_modules/@polymer/iron-behaviors/iron-button-state.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.IronButtonState = exports.IronButtonStateImpl = void 0;
...
const IronButtonStateImpl = {
  ...
  _spaceKeyDownHandler: function (event) {
    ...
    var target = (0, _polymerDom.dom)(keyboardEvent).localTarget; // Ignore the event if this is coming from a focused light child, since that
...
const IronButtonState = [_ironA11yKeysBehavior.IronA11yKeysBehavior, IronButtonStateImpl];
exports.IronButtonState = IronButtonState;
},{"@polymer/polymer/polymer-legacy.js":"node_modules/@polymer/polymer/polymer-legacy.js","./iron-control-state.js":"node_modules/@polymer/iron-behaviors/iron-control-state.js","@polymer/iron-a11y-keys-behavior/iron-a11y-keys-behavior.js":"node_modules/@polymer/iron-a11y-keys-behavior/iron-a11y-keys-behavior.js","@polymer/polymer/lib/legacy/polymer.dom.js":"node_modules/@polymer/polymer/lib/legacy/polymer.dom.js"}],"node_modules/@polymer/paper-ripple/paper-ripple.js":[function(require,module,exports) {
"use strict";
...
`,
  ...
  attached: function () {
    ...
    if ((0, _polymerDom.dom)(this).parentNode.nodeType == 11) {
      // DOCUMENT_FRAGMENT_NODE
      this.keyEventTarget = (0, _polymerDom.dom)(this).getOwnerRoot().host;
    } else {
      this.keyEventTarget = (0, _polymerDom.dom)(this).parentNode;
    }
...
},{"@polymer/polymer/polymer-legacy.js":"node_modules/@polymer/polymer/polymer-legacy.js","@polymer/iron-a11y-keys-behavior/iron-a11y-keys-behavior.js":"node_modules/@polymer/iron-a11y-keys-behavior/iron-a11y-keys-behavior.js","@polymer/polymer/lib/legacy/polymer-fn.js":"node_modules/@polymer/polymer/lib/legacy/polymer-fn.js","@polymer/polymer/lib/legacy/polymer.dom.js":"node_modules/@polymer/polymer/lib/legacy/polymer.dom.js","@polymer/polymer/lib/utils/html-tag.js":"node_modules/@polymer/polymer/lib/utils/html-tag.js"}],"node_modules/@polymer/paper-behaviors/paper-ripple-behavior.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.PaperRippleBehavior = void 0;
...
},{"@polymer/polymer/polymer-legacy.js":"node_modules/@polymer/polymer/polymer-legacy.js","@polymer/paper-ripple/paper-ripple.js":"node_modules/@polymer/paper-ripple/paper-ripple.js","@polymer/iron-behaviors/iron-button-state.js":"node_modules/@polymer/iron-behaviors/iron-button-state.js","@polymer/polymer/lib/legacy/polymer.dom.js":"node_modules/@polymer/polymer/lib/legacy/polymer.dom.js"}],"node_modules/@polymer/paper-behaviors/paper-inky-focus-behavior.js":[function(require,module,exports) {
"use strict";

Object.defineProperty(exports, "__esModule", {
  value: true
});
exports.PaperInkyFocusBehavior = exports.PaperInkyFocusBehaviorImpl = void 0;
...
var _paperInkyFocusBehavior = require("@polymer/paper-behaviors/paper-inky-focus-behavior.js");
...
},{"@polymer/polymer/polymer-legacy.js":"node_modules/@polymer/polymer/polymer-legacy.js","@polymer/iron-icon/iron-icon.js":"node_modules/@polymer/iron-icon/iron-icon.js","@polymer/paper-styles/default-theme.js":"node_modules/@polymer/paper-styles/default-theme.js","@polymer/paper-behaviors/paper-inky-focus-behavior.js":"node_modules/@polymer/paper-behaviors/paper-inky-focus-behavior.js","@polymer/polymer/lib/legacy/polymer-fn.js":"node_modules/@polymer/polymer/lib/legacy/polymer-fn.js","@polymer/polymer/lib/utils/html-tag.js":"node_modules/@polymer/polymer/lib/utils/html-tag.js"}],"node_modules/@polymer/iron-iconset-svg/iron-iconset-svg.js":[function(require,module,exports) {
"use strict";
...
(0, _polymerFn.Polymer)({
  ...
  created: function () {
    this._meta = new _ironMeta.IronMeta({
      type: 'iconset',
      key: null,
      value: null
    });
...
},{"@polymer/polymer/polymer-legacy.js":"node_modules/@polymer/polymer/polymer-legacy.js","@polymer/iron-meta/iron-meta.js":"node_modules/@polymer/iron-meta/iron-meta.js","@polymer/polymer/lib/legacy/polymer-fn.js":"node_modules/@polymer/polymer/lib/legacy/polymer-fn.js","@polymer/polymer/lib/legacy/polymer.dom.js":"node_modules/@polymer/polymer/lib/legacy/polymer.dom.js"}],"node_modules/@polymer/iron-icons/iron-icons.js":[function(require,module,exports) {
"use strict";
...
@demo demo/index.html
*/
const template = (0, _htmlTag.html)`<iron-iconset-svg name="icons" size="24">
<svg><defs>
...
document.head.appendChild(template.content);
},{"@polymer/iron-icon/iron-icon.js":"node_modules/@polymer/iron-icon/iron-icon.js","@polymer/iron-iconset-svg/iron-iconset-svg.js":"node_modules/@polymer/iron-iconset-svg/iron-iconset-svg.js","@polymer/polymer/lib/utils/html-tag.js":"node_modules/@polymer/polymer/lib/utils/html-tag.js"}],"src/components/app-toolbar.js":[function(require,module,exports) {
"use strict";
...
var AppToolbar = /*#__PURE__*/function (_LitElement) {
  _inherits(AppToolbar, _LitElement);

  var _super = _createSuper(AppToolbar);

  _createClass(AppToolbar, null, [{
    key: "properties",
    get: function get() {
      return {
        title: {
...
var MenuLink = /*#__PURE__*/function (_LitElement) {
  _inherits(MenuLink, _LitElement);

  var _super = _createSuper(MenuLink);

  _createClass(MenuLink, null, [{
    key: "properties",
    get: function get() {
      return {
        name: {
...
},{"lit-element":"node_modules/lit-element/lit-element.js"}],"src/components/menu-links.js":[function(require,module,exports) {
"use strict";
...
var MenuLinks = /*#__PURE__*/function (_LitElement) {
  _inherits(MenuLinks, _LitElement);

  var _super = _createSuper(MenuLinks);
...
},{"lit-element":"node_modules/lit-element/lit-element.js","./app-toolbar":"src/components/app-toolbar.js","./menu-links":"src/components/menu-links.js"}],"src/components/app-home.js":[function(require,module,exports) {
"use strict";
...
var AppHome = /*#__PURE__*/function (_LitElement) {
  _inherits(AppHome, _LitElement);

  var _super = _createSuper(AppHome);

  _createClass(AppHome, null, [{
    key: "properties",
    get: function get() {
      return {
        image: {
...
var MyApp = /*#__PURE__*/function (_LitElement) {
  _inherits(MyApp, _LitElement);
...
},{"lit-element":"node_modules/lit-element/lit-element.js","./components/app-header":"src/components/app-header.js","./components/app-home":"src/components/app-home.js"}],"node_modules/parcel-bundler/src/builtins/hmr-runtime.js":[function(require,module,exports) {
